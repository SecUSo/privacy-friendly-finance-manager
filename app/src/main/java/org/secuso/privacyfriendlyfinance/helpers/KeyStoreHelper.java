...
//            deleteKey();
    ...
    public char[] getKeyApi21(Context context) throws KeyStoreHelperException {
...
//    public char[] getKeyApiAbove21(Context context) throws KeyStoreHelperException {
//        String passphrase = SharedPreferencesManager.getDbPassphrase();
//
//        if (!keyExists()) {
//            try {
...
//        if (Build.VERSION.SDK_INT == 21) {
            return getKeyApi21(context);
//        } else {
//            return getKeyApiAbove21(context);
//        }
    }
...
//        if (Build.VERSION.SDK_INT == 21) {
            ...
            kpg.initialize(spec);
            api21RSAKeyPair = kpg.generateKeyPair();
//        } else {
//            deleteKey();
...
//        }
        ...
        inputCipher.init(Cipher.ENCRYPT_MODE, api21RSAKeyPair.getPublic());
...
//        }
        ...
        output.init(Cipher.DECRYPT_MODE, api21RSAKeyPair.getPrivate());
